...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! C:\Users\reaso_000\OneDrive\Projects\Websites\Personal\site2\site\js\pages\homepage.js */2);
	module.exports = __webpack_require__(/*! C:\Users\reaso_000\OneDrive\Projects\Websites\Personal\site2\site\js\main.js */1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! ./libraries/svg */ 4)
	...
	var pages = {};
	pageSpecificFiles.forEach(function(file) {
	  file = './pages/' + file;
	  var currentPage = __webpack_require__(/*! . */ 3)(file);
	  pages[currentPage.path] = currentPage;
	});
	
	var currentPath = window.location.href.replace(/[a-z]+:\/\/[^\/]+\//, '');
	if(pages[currentPath]) {
	  pages[currentPath].setup();
	}
...
/* 4 */
/*!**********************************!*\
  !*** ./site/js/libraries/svg.js ***!
  \**********************************/
/***/ function(module, exports, __webpack_require__) {

	var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;/* svg.js 1.0.1-4-g7984a87 - svg selector inventor polyfill regex default color array pointarray patharray number viewbox bbox rbox element parent container fx relative event defs group arrange mask clip gradient pattern doc shape symbol use rect ellipse line poly path image text textpath nested hyperlink marker sugar set data memory helpers - svgjs.com/license */
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function() {
	  ...
	  for(var i = 0; i < arguments.length; ++i) {
	    var currentPage = __webpack_require__(/*! . */ 6)(arguments[i]);
	    pages[currentPage.path] = currentPage;
	  }
	  return pages;
	}
